...
- [x] **Skip-to-content link** — Added to all 20 pages (EN: "Skip to content", GA: "Scipeáil chuig an bpríomhábhar").
...
## Content / Compliance
- [ ] **Privacy page vs GTM** — Privacy page says "no cookies" but GTM sets cookies after consent. Update privacy page to reflect cookie consent flow.
